...
git config --global user.name "Gregory Cowley"
git config --global user.email gregory@cowleystudios.com
...
cd ~
git clone git@github.com:gregorycowley/dot-factory .cfg
cd .dotfiles
sh symdotfiles
