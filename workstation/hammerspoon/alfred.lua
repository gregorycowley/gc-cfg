...
-- status.
--
hs.applescript.applescript("tell application \"Alfred 3\" to run trigger \"Launch\" in workflow \"com.customct.AnyBar\" with argument \"9595\" ")
...
function cafftoggle ()
	...
	if hs.caffeinate.get("system") then
		...
		hs.applescript.applescript("tell application \"Alfred 3\" to run trigger \"SetGraphic\" in workflow \"com.customct.AnyBar\" with argument \"sleep_red|9595\" ")
	else
		hs.caffeinate.set("displayIdle", false, true)
		hs.caffeinate.set("systemIdle", false, true)
		hs.alert.show("Caff is disabled!", 3)
		hs.applescript.applescript("tell application \"Alfred 3\" to run trigger \"SetGraphic\" in workflow \"com.customct.AnyBar\" with argument \"sleep_black|9595\" ")
	end
end
